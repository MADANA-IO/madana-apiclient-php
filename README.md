...
*EnclaveServiceApi* | [**getStats**](docs/Api/EnclaveServiceApi.md#getstats) | **GET** /enclaves/stats | 
...
*NodeServiceApi* | [**createNode**](docs/Api/NodeServiceApi.md#createnode) | **POST** /nodes/v2 | 
*NodeServiceApi* | [**getBootstrap**](docs/Api/NodeServiceApi.md#getbootstrap) | **GET** /nodes/bootstrap | 
*NodeServiceApi* | [**getNodeLicenses**](docs/Api/NodeServiceApi.md#getnodelicenses) | **GET** /nodes/licenses | 
*NodeServiceApi* | [**getNodeV2**](docs/Api/NodeServiceApi.md#getnodev2) | **GET** /nodes/v2/{ident} | 
*NodeServiceApi* | [**getNodes2**](docs/Api/NodeServiceApi.md#getnodes2) | **GET** /nodes | 
*NodeServiceApi* | [**getNodesV2**](docs/Api/NodeServiceApi.md#getnodesv2) | **GET** /nodes/v2 | Returns UUIDs of existing analyses.
*NodeServiceApi* | [**killNode**](docs/Api/NodeServiceApi.md#killnode) | **POST** /nodes/v2/{ident}/kill | 
*NodeServiceApi* | [**postNodeInfo**](docs/Api/NodeServiceApi.md#postnodeinfo) | **POST** /nodes | 
*NodeServiceApi* | [**postNodeInfo_0**](docs/Api/NodeServiceApi.md#postnodeinfo_0) | **POST** /nodes/create | 
...
*SubscriptionServiceApi* | [**getCheckoutSession**](docs/Api/SubscriptionServiceApi.md#getcheckoutsession) | **GET** /subscriptions/{productname}/checkout | 
*SubscriptionServiceApi* | [**getCheckoutSession2**](docs/Api/SubscriptionServiceApi.md#getcheckoutsession2) | **POST** /subscriptions/{productname}/{newplan} | 
...
*UserServiceApi* | [**cancelSubscription**](docs/Api/UserServiceApi.md#cancelsubscription) | **POST** /users/{username}/subscriptions/{planname}/cancel | 
...
- [JsonNodeRunRequest](docs/Model/JsonNodeRunRequest.md)
