...
*EnclaveServiceApi* | [**redistTest**](docs/Api/EnclaveServiceApi.md#redisttest) | **GET** /enclaves/test/redis | 
...
*SystemServiceApi* | [**getApplication**](docs/Api/SystemServiceApi.md#getapplication) | **GET** /system/usage | Return the current application usage.
