...
/**
 * XmlNs0KubernetesEnclave Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class XmlNs0KubernetesEnclave implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'xml_ns0_kubernetesEnclave';
